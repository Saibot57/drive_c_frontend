      ...
      <DialogContent className="max-h-[90vh] max-w-md overflow-y-auto">
        ...
        >
          ...
          {/* Kryssrutor, inte radioknappar: någon enstaka läser två kurser.
              Vilka som får kombineras avgör `toggleMathOption`. Hjälptexten
              säger med flit ingenting om det — det är så ovanligt att
              arbetslaget inte vill att deltagarna ska tro att man kan välja två
              kurser hur som helst. */}
          <fieldset>
